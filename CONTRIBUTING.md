...
Thanks for helping improve this project. This repository maintains the Docker image for Kokoro TTS; changes that only affect multi-service orchestration belong in [docker-ai-stack](https://github.com/hwdsl2/docker-ai-stack).
