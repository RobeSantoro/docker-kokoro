...
**另請參閱：[Docker AI Stack](https://github.com/hwdsl2/docker-ai-stack/blob/main/README-zh-Hant.md)** — 一鍵部署完整 AI 技術堆疊的 docker-compose 設定和流水線範例。了解更多關於完整 AI 技術堆疊的部署方法。
